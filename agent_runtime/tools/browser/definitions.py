...
BROWSER_TOOLS = (
    ToolDefinition(
        ...
        "browser_open", _CAP, ToolAnnotations(destructive=True, open_world=True), execution_kind=_HOST, operation_permissions=_CONTROL,
    ),
    ToolDefinition(
        ...
        "browser_navigate", _CAP, ToolAnnotations(destructive=True, open_world=True), execution_kind=_HOST, operation_permissions=_CONTROL,
    ),
    ToolDefinition(
        ...
        "browser_snapshot", _CAP, ToolAnnotations(read_only=True), execution_kind=_HOST, operation_permissions=_OBSERVE,
    ),
    ToolDefinition(
        ...
        "browser_click", _CAP, ToolAnnotations(destructive=True, open_world=True), execution_kind=_HOST, operation_permissions=_CONTROL,
    ),
    ToolDefinition(
        ...
        "browser_fill", _CAP, ToolAnnotations(destructive=True, open_world=True), execution_kind=_HOST, operation_permissions=_CONTROL,
    ),
    ToolDefinition(
        ...
        "browser_press", _CAP, ToolAnnotations(destructive=True, open_world=True), execution_kind=_HOST, operation_permissions=_CONTROL,
    ),
    ToolDefinition(
        ...
        "browser_screenshot", _CAP, ToolAnnotations(read_only=True), execution_kind=_HOST, operation_permissions=_OBSERVE,
    ),
    ToolDefinition(
