...
<template>
  ...
  >
    ...
    >
      ...
      <p v-else-if="isDesktopControl" class="mt-3 mb-0 text-[10px] leading-[15px] text-muted-foreground">此权限只针对当前 desktop 调用中已明确选择的目标窗口，用于鼠标、键盘、滚动或拖拽。Workbench 的本次/资源会话授权与 macOS 辅助功能权限彼此独立；未获得系统权限时本次操作仍会在 Host 侧失败。</p>
      ...
      <footer class="mt-4 flex justify-end gap-2">
        ...
        <div v-else-if="hasResourceSession" class="flex gap-2">
